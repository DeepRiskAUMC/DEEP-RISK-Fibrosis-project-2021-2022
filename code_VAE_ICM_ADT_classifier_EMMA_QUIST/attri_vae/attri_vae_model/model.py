...
class ConvVAE(nn.Module):
    ...
    def __init__(self, image_channels, h_dim, latent_size, n_filters_ENC, n_filters_DEC, img_size):
        super(ConvVAE, self).__init__()
        self.image_channels = image_channels
        self.bnc = n_filters_ENC[-1]
        self.h_dim = h_dim
    ...
    ##############
        ...
        flat_dim = int(self.bnc * img_size/16 * img_size/16 * img_size/16)
        self.flat_dim = flat_dim     
        self.fc1 = nn.Linear(flat_dim, flat_dim//2)  

        self.fc2 = nn.Linear(flat_dim//2, (self.latent_size + self.latent_size//2))
