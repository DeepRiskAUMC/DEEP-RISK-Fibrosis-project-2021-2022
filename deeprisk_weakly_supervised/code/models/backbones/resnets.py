...
class ResNet(BaseNet):
    ...
    def __init__(self, block, layers, zero_init_residual=False,
                 ...
                 norm_layer=None, deep_base=False, in_chans=1):
        ...
        if not self.deep_base: # see PSPNet implementation
            self.inplanes = 64
            ...
            self.inplanes = 128
            self.conv1 = conv3x3(in_chans, 64, stride=2)
        ...
        # note no global pooling of fully-connected layers
...
class ResNet50(ResNet):
    ...
    def __init__(self, in_chans=1, **kwargs):
